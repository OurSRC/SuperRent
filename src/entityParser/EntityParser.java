...
public class EntityParser {
    ...
    /**
     * Read data from ResultSet, and populate entity object based on defined attributeParsers.
     * This method process one result in resultset only, ResultSet.next() need to be called manually.
     * @param rs ResultSet with results
     * @param entity Entity object to populate
     * @param ap AttributeParsers that defines mapping between database and entity object
     */
    ...
    /**
     * Generate set expression that used to update database.
     * E.g. If attribute "password" of value "abc" in entity class has correspond 
     * database column "Password", it will generate "Password='abc'"
