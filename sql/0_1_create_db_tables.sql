...
CREATE TABLE `item` (
  ...
  `Type` enum('VEHICLE','EQUIPMENT','DELAY','MILE','DAMAGE','MEMBERSHIP','TICKET','POINTEXCHANGE','INSURANCE','FUEL','OTHER') NOT NULL,
...
CREATE TABLE `vehicle` (
  ...
  `BranchId` int(11) NOT NULL,
  `Status` enum('FORRENT','FORSALE') NOT NULL,
...
-- Dump completed on 2014-04-24 18:47:10
